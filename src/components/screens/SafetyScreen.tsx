...
const SAFE_ZONES = [
  ...
  {
    name: "Văn phòng Viettel (Tỉa Dũng)",
    desc: "Trần Hữu Dực, Nam Từ Liêm",
    icon: Briefcase,
  },
  {
    name: "Bệnh viện Lão khoa Trung Ương",
    desc: "Phương Mai, Đống Đa",
    icon: Hospital,
  },
];
    ...
    <div className="space-y-4 pb-20 w-full max-w-full px-4 pt-2">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-bold text-stone-900">
            An toàn & Định vị gia đình
          </h2>
          <p className="text-[11px] text-stone-500">
            Giữ kết nối yêu thương và an tâm mọi lúc
          </p>
        </div>
        <button
          ...
          {SAFE_ZONES.map((zone, i) => {
            ...
            return (
              <button
                key={i}
                onClick={() =>
                  onCheckIn(zone.name, `Đã đến ${zone.name} an toàn.`)
                }
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-orange-100">
              Nhận tin nhắn SOS & tin khẩn ngay trên màn hình ngoài di động
            </p>
          </div>
        </div>
        <button
      ...
      <div className="bg-linear-to-br from-blue-50 to-indigo-50 rounded-3xl p-4 border border-blue-200/80 shadow-xs space-y-3">
        ...
        <p className="text-xs text-blue-900/80">
          Khi con đi học về muộn hoặc ông bà đi tập thể dục, bật chia sẻ vị trí
          ...
          <div className="p-3 bg-white rounded-2xl border border-blue-200 flex items-center justify-between">
            <div className="text-xs">
              <span className="font-bold text-stone-900 block">
                Vị trí của bạn đang hiển thị
              </span>
              <span className="text-stone-500">
                Tự động kết thúc sau: 45 phút
              </span>
            </div>
            <button
        ...
        <div className="space-y-4 text-center py-2">
          {sosActive ? (
            <div className="space-y-3">
              ...
              <p className="text-xs text-stone-600">
                Toàn bộ thành viên trong gia đình và liên hệ khẩn cấp đã nhận
                được chuông cảnh báo và toạ độ vị trí hiện tại của bạn.
              </p>
              <div className="p-3 bg-red-50 rounded-2xl text-xs text-red-950 text-left space-y-1">
                ...
                <p>
                  📞 Đang kết nối cuộc gọi ưu tiên tới: Tỉa Dũng (0912 345 678)
                </p>
              </div>
              <button
                onClick={() => {
            ...
            <div className="space-y-4">
              <p className="text-xs text-stone-600">
                Nhấn và giữ nút SOS trong <strong>3 giây</strong> để tránh chạm
                nhầm. Cảnh báo sẽ ngay lập tức gửi chuông báo ưu tiên đến điện
                thoại tất cả người thân.
              </p>
